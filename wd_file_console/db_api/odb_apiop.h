...
public:
	...
	//
	int GetNameStringByID(const int reference_id, std::string& ref_string);
	int GetNameStringByID(const int reference_id, char*& referenced_namebuf, int& namebuf_size);
	
	//
	int GetNameStringByID(const std::vector<int>& vec_refid, std::vector<std::string>& vec_ref_string);

	//
	int	GetNameStringByKeyID(const struct KEY_ID_STRU& keyid_stru, std::string& ref_string);
	int	GetNameStringByKeyID(const std::vector<struct KEY_ID_STRU>& vec_keyid, std::vector<string>& vec_ref_string);
	
	int	GetNameStringByKeyID( const struct KEY_ID_STRU& keyid_stru, char*& referenced_namebuf, int& namebuf_size);
...
public:
	int ColMeasType( const struct KEY_ID_STRU keyid , int& col_prop );
...
public:
	...
	int GetFieldNoFromKeyId(const std::vector<struct KEY_ID_STRU> &struVec , std::vector<int> &FieldNoVec);
private:
	...
	int GetPosFromKeyIdStru(const std::vector<struct KEY_ID_STRU> &struVec , vector<int> &errPosVec , vector<IntVec> &posVec);
