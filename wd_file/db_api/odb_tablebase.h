...
public:
	...
	virtual int	GetNameStringByKeyID(const struct KEY_ID_STRU& keyid_stru, string& ref_string){ return 0; }
	virtual int	GetNameStringByKeyID(const std::vector<struct KEY_ID_STRU>& vec_keyid, std::vector<string>& vec_ref_string){ return 0; }

	virtual int GetNameStringByID(const int reference_id, string& ref_string){ return 0; }
	...
	virtual int	GetNameStringByAppID( const std::vector<struct APP_ID_STRU>& vec_appid, std::vector<string>& vec_name_string){ return 0; }
...
public:
	...
	virtual int	GetFacNameByFacID(char* fac_name, const int fac_id) { return 0; }
	virtual int	GetFacNameByFacNo(char* fac_name, const short fac_no) { return 0; }

	virtual int	GetFacIDByFacName(int& fac_id, const char* fac_name) { return 0; }	
	virtual int	GetFacNoByFacName(short& fac_no, const char* fac_name) { return 0; }
	
	virtual int	GetFacIDByFacNo(int& fac_id, const short fac_no) { return 0; }
	virtual int GetFacNoByFacID(short& fac_no, const int fac_id) { return 0; }
};
