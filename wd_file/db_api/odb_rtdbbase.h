...
class CRtdbBase
#else
class ODB_API_LIB_API CRtdbBase
#endif
{
public:
	CRtdbBase(){}
...
public:
	...
	virtual int	GetNameStringByKeyID(const struct KEY_ID_STRU& keyid_stru, string& ref_string) = 0;
	
	virtual int	GetNameStringByKeyID(const std::vector<struct KEY_ID_STRU>& vec_keyid, std::vector<string>& vec_ref_string) = 0;

	virtual int GetNameStringByID(const int reference_id, string& ref_string) = 0;
	...
	virtual int	GetNameStringByAppID( const std::vector<struct APP_ID_STRU>& vec_appid, std::vector<string>& vec_name_string) = 0;
...
public:
	...
	virtual int	GetFacNameByFacID(char* fac_name, const int fac_id) = 0;
	virtual int	GetFacNameByFacNo(char* fac_name, const short fac_no) = 0;
	
	virtual int	GetFacIDByFacName(int& fac_id, const char* fac_name) = 0;
	//virtual int	GetFacNoByFacName(int& fac_no, const char* fac_name) = 0;  //obsolete 2004-04-03
	virtual int   GetFacNoByFacName(short& fac_no, const char* fac_name) = 0;

	//virtual int	GetFacIDByFacNo(int& fac_id, const int fac_no) = 0;    //obsolete   2004-04-03
	virtual int   GetFacIDByFacNo(int& fac_id, const short fac_no) = 0;
	virtual int   GetFacNoByFacID(short& fac_no, const int fac_id) = 0;
